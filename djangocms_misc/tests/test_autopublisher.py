...
class AutoPublisherTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self._admin_user = User.objects.create_superuser(
            username="admin", email=None, password=self.password
        )
    ...
    def test_save_page(self):
        ...
        # normaly, a page is saved with a title. works via frontend, though!?
    ...
    def test_add_save_plugin(self):
        ...
        plugin.save()
        # TODO: inconsistency, publish should not be needed,
        # but appearently, dirty state is not applied when saving
